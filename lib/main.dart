...
void main() async {
  runZonedGuarded<Future<void>>(() async {
    ...
    // Initialisation de Firebase & Crashlytics
    if (!kIsWeb && (Platform.isAndroid || Platform.isIOS)) {
      try {
        await Firebase.initializeApp();
        
        // Capturer les erreurs d'assertion et exceptions fatales du framework Flutter
        ...
        // Optionnel : Activer la collecte d'Analytics
    ...
    // Initialisation du service de synchronisation Firebase Data Connect
